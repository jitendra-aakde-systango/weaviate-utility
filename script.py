...
# SOURCE_WEAVIATE_URL = "https://35.207.247.72:5504"  # Your source endpoint
# TARGET_WEAVIATE_URL = "http://localhost:5504"  # Your target endpoint
# source_class = "Board_374"
# target_class = "Board_374"

SOURCE_WEAVIATE_URL = "http://35.207.247.72:5504"  # Your source endpoint
TARGET_WEAVIATE_URL = "http://localhost:5504"  # Your target endpoint
source_class = "Board_374"
target_class = "Board_1054"


# source_class = "SearchProduct_8"
# target_class = "good_food_corp_backup"

# production envs
# https://infomente-be.envistudios.com/weaviate-service/
# https://documente-be.envistudios.com/weaviate-service/




import weaviate
auth_config = weaviate.AuthApiKey(api_key="abcdefghijkl")
source_client = Client(url=SOURCE_WEAVIATE_URL, auth_client_secret=auth_config)
target_client = Client(url=TARGET_WEAVIATE_URL, auth_client_secret=auth_config)
